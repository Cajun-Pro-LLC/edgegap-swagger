...
/*
EndpointStorageApiService Create a New Endpoint Storage
...
func (a *EndpointStorageApiService) EndpointCreate(ctx context.Context, payload EndpointStoragePostPayload) (EndpointStoragePostResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue EndpointStoragePostResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EndpointStoragePostResponse
...
/*
EndpointStorageApiService Delete an Endpoint Storage
...
func (a *EndpointStorageApiService) EndpointDelete(ctx context.Context, endpointName string) (EndpointStorageDeleteResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue EndpointStorageDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint/{endpoint_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint_name"+"}", fmt.Sprintf("%v", endpointName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EndpointStorageDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService Get an Endpoint Storage
...
func (a *EndpointStorageApiService) EndpointGet(ctx context.Context, endpointName string) (EndpointStorageGetResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue EndpointStorageGetResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EndpointStorageGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService Update an Endpoint Storage
...
func (a *EndpointStorageApiService) EndpointUpdate(ctx context.Context, endpointName string, payload EndpointStoragePatchPayload) (EndpointStoragePatchResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue EndpointStoragePatchResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EndpointStoragePatchResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService List All Endpoint Storage
List all endpoint storage.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EndpointStorageApiEndpointsListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  Page number for pagination
     * @param "Limit" (optional.Int32) -  Limit of Fleet for each page
     * @param "XFields" (optional.String) -  An optional fields mask

@return EndpointStorageListResponse
*/
...
func (a *EndpointStorageApiService) EndpointsList(ctx context.Context, localVarOptionals *EndpointStorageApiEndpointsListOpts) (EndpointStorageListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue EndpointStorageListResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoints"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EndpointStorageListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService Create a New Pull Profile
...
func (a *EndpointStorageApiService) PullProfileCreate(ctx context.Context, endpointName string, payload PullProfilePostPayload) (PullProfilePostResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PullProfilePostResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint/{endpoint_name}/pull-profile"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint_name"+"}", fmt.Sprintf("%v", endpointName), -1)
...
/*
EndpointStorageApiService Delete a Pull Profile
...
func (a *EndpointStorageApiService) PullProfileDelete(ctx context.Context, endpointName string, pullProfileName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint/{endpoint_name}/pull-profile/{pull_profile_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint_name"+"}", fmt.Sprintf("%v", endpointName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pull_profile_name"+"}", fmt.Sprintf("%v", pullProfileName), -1)
...
/*
EndpointStorageApiService Get a Pull Profile
...
func (a *EndpointStorageApiService) PullProfileGet(ctx context.Context, endpointName string, pullProfileName string) (PullProfileGetResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PullProfileGetResponse
	)
...
/*
EndpointStorageApiService Link a Pull Profile to an Application Version
...
func (a *EndpointStorageApiService) PullProfileLinkAppVersion(ctx context.Context, endpointName string, pullProfileName string, appName string, versionName string) (PullProfileAppVersionLinkResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PullProfileAppVersionLinkResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint/{endpoint_name}/pull-profile/{pull_profile_name}/app/{app_name}/version/{version_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint_name"+"}", fmt.Sprintf("%v", endpointName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"pull_profile_name"+"}", fmt.Sprintf("%v", pullProfileName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PullProfileAppVersionLinkResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService List All Pull Profile of an Endpoint Storage
List all pull profiles of an endpoint storage.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param endpointName
 * @param optional nil or *EndpointStorageApiPullProfileListOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  Page number for pagination
     * @param "Limit" (optional.Int32) -  Limit of pull profiles for each page

@return PullProfilesListResponse
*/
...
func (a *EndpointStorageApiService) PullProfileList(ctx context.Context, endpointName string, localVarOptionals *EndpointStorageApiPullProfileListOpts) (PullProfilesListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PullProfilesListResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/storage/endpoint/{endpoint_name}/pull-profiles"
	localVarPath = strings.Replace(localVarPath, "{"+"endpoint_name"+"}", fmt.Sprintf("%v", endpointName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PullProfilesListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
EndpointStorageApiService Unlink a Pull Profile From an Application Version
...
/*
EndpointStorageApiService Update a Pull Profile
...
func (a *EndpointStorageApiService) PullProfileUpdate(ctx context.Context, endpointName string, pullProfileName string, payload PullProfilePatchPayload) (PulloProfilePatchResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PulloProfilePatchResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PulloProfilePatchResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
