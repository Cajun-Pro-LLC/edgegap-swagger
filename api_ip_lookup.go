...
/*
IPLookupApiService Get Your Public IP
...
func (a *IPLookupApiService) IP(ctx context.Context) (IpAddressResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/v1/ip"
...
/*
IPLookupApiService Get an IP&#39;s information
...
func (a *IPLookupApiService) IPLookup(ctx context.Context, ip string) (IpAddressLookupResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue IpAddressLookupResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/ip/{ip}/lookup"
...
/*
IPLookupApiService Get IPs Information in Bulk
...
func (a *IPLookupApiService) IPsLookup(ctx context.Context, payload IpAddressesLookupPayload) (IpAddressesLookupResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue IpAddressesLookupResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/ips/lookup"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v IpAddressesLookupResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
