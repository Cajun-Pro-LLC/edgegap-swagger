...
/*
SessionsApiService Get a Session
...
/*
SessionsApiService List Users of a Session
...
/*
SessionsApiService List All Sessions
...
/*
SessionsApiService Put Users in a Session
...
/*
SessionsApiService Delete a Session
...
func (a *SessionsApiService) SessionDelete(ctx context.Context, sessionId string) (SessionDelete, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SessionDelete
	)
...
/*
SessionsApiService Create a Session
...
/*
SessionsApiService Delete Sessions in Bulk
...
func (a *SessionsApiService) SessionsBulkStop(ctx context.Context, payload SessionBulkStopPayload) (SessionBulkStopResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SessionBulkStopResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/sessions/bulk-stop"
