...
/*
FleetsApiService Create a Fleet
...
func (a *FleetsApiService) FleetCreate(ctx context.Context, payload FleetPostPayload) (FleetPostResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue FleetPostResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleet"
...
/*
FleetsApiService Delete a Fleet
...
func (a *FleetsApiService) FleetDelete(ctx context.Context, fleetName string) (FleetDeleteResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue FleetDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleet/{fleet_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"fleet_name"+"}", fmt.Sprintf("%v", fleetName), -1)
...
/*
FleetsApiService Link an Application Version to a Fleet
...
func (a *FleetsApiService) FleetLinkAppVersion(ctx context.Context, fleetName string, appName string, versionName string) (HorizontalScalerAppVersionLink, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue HorizontalScalerAppVersionLink
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleet/{fleet_name}/app/{app_name}/version/{version_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"fleet_name"+"}", fmt.Sprintf("%v", fleetName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v HorizontalScalerAppVersionLink
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FleetsApiService Create a Fleet Policy
...
func (a *FleetsApiService) FleetPoliciesCreate(ctx context.Context, fleetName string, payload FleetPoliciesPostPayload) (FleetPoliciesPostResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue FleetPoliciesPostResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleet/{fleet_name}/policies"
	localVarPath = strings.Replace(localVarPath, "{"+"fleet_name"+"}", fmt.Sprintf("%v", fleetName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FleetPoliciesPostResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FleetsApiService Delete a Policy
...
func (a *FleetsApiService) FleetPoliciesDelete(ctx context.Context, fleetName string, policyName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleet/{fleet_name}/policies/{policy_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"fleet_name"+"}", fmt.Sprintf("%v", fleetName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"policy_name"+"}", fmt.Sprintf("%v", policyName), -1)
...
func (a *FleetsApiService) FleetPoliciesGet(ctx context.Context, fleetName string, policyName string) (FleetPoliciesGetResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue FleetPoliciesGetResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FleetPoliciesGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FleetsApiService List All Policies of a Fleet
List all the policies of a fleet.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fleetName The name of the fleet
 * @param optional nil or *FleetsApiFleetPoliciesListOpts - Optional Parameters:
...
@return HorizontalScalerConstraintList
*/
...
func (a *FleetsApiService) FleetPoliciesList(ctx context.Context, fleetName string, localVarOptionals *FleetsApiFleetPoliciesListOpts) (HorizontalScalerConstraintList, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue HorizontalScalerConstraintList
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v HorizontalScalerConstraintList
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FleetsApiService Update a Policy
...
func (a *FleetsApiService) FleetPoliciesUpdate(ctx context.Context, fleetName string, policyName string, payload FleetPoliciesPatchPayload) (FleetPoliciesPatchPayload, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue FleetPoliciesPatchPayload
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FleetPoliciesPatchPayload
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FleetsApiService Unlink an Application Version From a Fleet
...
/*
FleetsApiService Update a Fleet
...
func (a *FleetsApiService) FleetUpdate(ctx context.Context, fleetName string, payload FleetPatchPayload) (FleetPatchResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue FleetPatchResponse
	)
...
/*
FleetsApiService List All Fleets
List all the fleets you own.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FleetsApiFleetsOpts - Optional Parameters:
     * @param "Page" (optional.Int32) -  Page number for pagination
     * @param "Limit" (optional.Int32) -  Limit of Fleet for each page
...
func (a *FleetsApiService) Fleets(ctx context.Context, localVarOptionals *FleetsApiFleetsOpts) (FleetList, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fleets"
