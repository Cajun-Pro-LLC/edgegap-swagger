...
/*
DeploymentTagsApiService Create Tag for a Deployment
...
func (a *DeploymentTagsApiService) DeploymentsTagsCreate(ctx context.Context, requestId string, payload DeploymentTagPayload) (DeploymentTagResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue DeploymentTagResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/deployments/{request_id}/tags"
...
/*
DeploymentTagsApiService Delete Tag for a Deployment
...
func (a *DeploymentTagsApiService) DeploymentsTagsDelete(ctx context.Context, requestId string, tagName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/deployments/{request_id}/tags/{tag_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"request_id"+"}", fmt.Sprintf("%v", requestId), -1)
...
/*
DeploymentTagsApiService List tags for a Deployment
...
func (a *DeploymentTagsApiService) DeploymentsTagsList(ctx context.Context, requestId string) (DeploymentTagListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DeploymentTagListResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DeploymentTagListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
DeploymentTagsApiService Get tag for a Deployment
...
/*
DeploymentTagsApiService Update Tag for a Deployment
