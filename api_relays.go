...
/*
RelaysApiService Create a Relay Session
...
func (a *RelaysApiService) RelaySessionCreate(ctx context.Context, payload RelaySessionCreatePayload) (RelaySessionBaseResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue RelaySessionBaseResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/relays/sessions"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RelaySessionBaseResponse
...
/*
RelaysApiService Delete a Relay Session
...
func (a *RelaysApiService) RelaySessionDelete(ctx context.Context, sessionId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/relays/sessions/{session_id}"
...
/*
RelaysApiService Get a Relay Session
...
/*
RelaysApiService List all Relay Sessions
...
func (a *RelaysApiService) RelaySessionList(ctx context.Context) (RelaySessionListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue RelaySessionListResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RelaySessionListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
RelaysApiService Authorize a user on a Relay Session
...
func (a *RelaysApiService) RelayUserAuthorize(ctx context.Context, payload RelayUserAuthorizePayload) (RelaySessionUserBaseResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue RelaySessionUserBaseResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/relays/sessions:authorize-user"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RelaySessionUserBaseResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
RelaysApiService Remove a user on a Relay Session
Authorize a user on a Relay Session
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param payload
...
func (a *RelaysApiService) RelayUserRevoke(ctx context.Context, payload RelayUserRevokePayload) (RelaySessionBaseResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/relays/sessions:revoke-user"
