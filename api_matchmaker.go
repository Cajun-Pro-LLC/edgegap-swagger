...
/*
MatchmakerApiService Delete a Matchmaker
Delete a matchmaker.
...
func (a *MatchmakerApiService) DeleteMatchmaker(ctx context.Context, matchmakerName string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
...
/*
MatchmakerApiService Delete a Matchmaker Component
...
func (a *MatchmakerApiService) DeleteMatchmakerComponent(ctx context.Context, componentName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/component/{component_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"component_name"+"}", fmt.Sprintf("%v", componentName), -1)
...
/*
MatchmakerApiService Delete a Matchmaker Component ENV
...
func (a *MatchmakerApiService) DeleteMatchmakerComponentEnv(ctx context.Context, componentName string, envKey string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/component/{component_name}/env/{env_key}"
	localVarPath = strings.Replace(localVarPath, "{"+"component_name"+"}", fmt.Sprintf("%v", componentName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"env_key"+"}", fmt.Sprintf("%v", envKey), -1)
...
/*
MatchmakerApiService Delete a Matchmaker Managed Release
...
func (a *MatchmakerApiService) DeleteMatchmakerManagedRelease(ctx context.Context, matchmakerName string, releaseVersion string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}/release/managed/{release_version}"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"release_version"+"}", fmt.Sprintf("%v", releaseVersion), -1)
...
/*
MatchmakerApiService Delete a Matchmaker Release
...
func (a *MatchmakerApiService) DeleteMatchmakerRelease(ctx context.Context, matchmakerName string, releaseVersion string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}/release/{release_version}"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"release_version"+"}", fmt.Sprintf("%v", releaseVersion), -1)
...
/*
MatchmakerApiService Delete a Matchmaker Release Config
...
func (a *MatchmakerApiService) DeleteMatchmakerReleaseConfig(ctx context.Context, configName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/release/config/{config_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"config_name"+"}", fmt.Sprintf("%v", configName), -1)
...
/*
MatchmakerApiService List All Matchmaker Components
...
func (a *MatchmakerApiService) GetComponentList(ctx context.Context) (MatchmakerComponentListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerComponentListResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/components"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerComponentListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
...
/*
MatchmakerApiService List All Matchmaker Component ENVs
...
func (a *MatchmakerApiService) GetEnvsList(ctx context.Context, componentName string) (MatchmakerComponentEnvListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerComponentEnvListResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/component/{component_name}/envs"
	localVarPath = strings.Replace(localVarPath, "{"+"component_name"+"}", fmt.Sprintf("%v", componentName), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerComponentEnvListResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService Get a Matchmaker
...
func (a *MatchmakerApiService) GetMatchmaker(ctx context.Context, matchmakerName string) (MatchmakerResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerResponse
	)
...
/*
MatchmakerApiService Get a Matchmaker Component
...
func (a *MatchmakerApiService) GetMatchmakerComponent(ctx context.Context, componentName string) (MatchmakerComponentResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerComponentResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerComponentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService Get a Matchmaker Component ENV
...
func (a *MatchmakerApiService) GetMatchmakerComponentEnv(ctx context.Context, componentName string, envKey string) (MatchmakerComponentEnvsResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerComponentEnvsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerComponentEnvsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService List All Matchmakers
...
func (a *MatchmakerApiService) GetMatchmakerList(ctx context.Context) (MatchmakerListResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerListResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmakers"
...
/*
MatchmakerApiService Get a Matchmaker Managed Release
...
func (a *MatchmakerApiService) GetMatchmakerManagedRelease(ctx context.Context, matchmakerName string, releaseVersion string) (MatchmakerManagedReleaseResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerManagedReleaseResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerManagedReleaseResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService Get a Matchmaker Release
...
func (a *MatchmakerApiService) GetMatchmakerRelease(ctx context.Context, matchmakerName string, releaseVersion string) (MatchmakerReleaseResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerReleaseResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerReleaseResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService Get a Matchmaker Release Config
...
func (a *MatchmakerApiService) GetMatchmakerReleaseConfig(ctx context.Context, configName string) (MatchmakerReleaseConfigResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MatchmakerReleaseConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MatchmakerReleaseConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MatchmakerApiService List All Matchmaker Release Configs
...
func (a *MatchmakerApiService) GetReleaseConfigsList(ctx context.Context) (MatchmakerComponentEnvListResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/release/configs"
...
/*
MatchmakerApiService List All Matchmaker Releases
...
func (a *MatchmakerApiService) GetReleaseList(ctx context.Context, matchmakerName string) (MatchmakerComponentEnvListResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}/releases"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
...
/*
MatchmakerApiService Update a Matchmaker
...
/*
MatchmakerApiService Update a Matchmaker Component
...
/*
MatchmakerApiService Update a Matchmaker Component ENV
...
/*
MatchmakerApiService Update a Matchmaker Managed Release
...
/*
MatchmakerApiService Update a Matchmaker Release
...
/*
MatchmakerApiService Update a Matchmaker Release Config
...
/*
MatchmakerApiService Create a Matchmaker
...
func (a *MatchmakerApiService) PostMatchmaker(ctx context.Context, payload MatchmakerCreate) (MatchmakerResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker"
...
/*
MatchmakerApiService Create a Matchmaker Component
...
func (a *MatchmakerApiService) PostMatchmakerComponent(ctx context.Context, payload MatchmakerComponentCreate) (MatchmakerComponentResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/component"
...
/*
MatchmakerApiService Create a Matchmaker Component ENV
...
func (a *MatchmakerApiService) PostMatchmakerComponentEnv(ctx context.Context, componentName string, payload MatchmakerComponentEnvsCreate) (MatchmakerComponentEnvsResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/component/{component_name}/env"
	localVarPath = strings.Replace(localVarPath, "{"+"component_name"+"}", fmt.Sprintf("%v", componentName), -1)
...
/*
MatchmakerApiService Create a Matchmaker Managed Release
...
func (a *MatchmakerApiService) PostMatchmakerManagedRelease(ctx context.Context, matchmakerName string, payload MatchmakerManagedReleaseCreate) (MatchmakerManagedReleaseResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}/release/managed"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
...
/*
MatchmakerApiService Create a Matchmaker Release
...
func (a *MatchmakerApiService) PostMatchmakerRelease(ctx context.Context, matchmakerName string, payload MatchmakerReleaseCreate) (MatchmakerReleaseResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/matchmaker/{matchmaker_name}/release"
	localVarPath = strings.Replace(localVarPath, "{"+"matchmaker_name"+"}", fmt.Sprintf("%v", matchmakerName), -1)
...
/*
MatchmakerApiService Create a Matchmaker Release Config
...
func (a *MatchmakerApiService) PostMatchmakerReleaseConfig(ctx context.Context, payload MatchmakerReleaseConfigCreate) (MatchmakerReleaseConfigResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/aom/release/config"
