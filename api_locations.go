...
/*
LocationsApiService List All Location Beacons
...
func (a *LocationsApiService) LocationBeaconList(ctx context.Context) (LocationBeaconList, *http.Response, error) {
	var (
		...
		localVarReturnValue LocationBeaconList
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/locations/beacons"
...
/*
LocationsApiService List All Locations
 ...
 * @param optional nil or *LocationsApiLocationsGetOpts - Optional Parameters:
     ...
     * @param "Type_" (optional.String) -  The type of the location
     * @param "Tags" (optional.String) -  Gets locations with tags. Set to: \&quot;true\&quot; to have the tags
